...
const Home = () => {
  const [eurekas, setEurekas] = useState([
    {title: 'Naval Ravikant Quote', date: '7/6/2024', body: '“Your life is a firefly blink in a night. You’re here for such a brief period of time. If you fully acknowledge the futility of what you’re doing, then I think it can bring great happiness and peace because you realize this is a game.”'}, 
    {title: 'Sextus Quote', date: '7/6/2024', body: '“Absence makes the heart grow fonder”'}, 
    {title: 'Mirror Neurons', date: '7/6/2024', body: '“A subset of neurons that play a crucial role in our ability to understand and imitate the actions of others. They’re activated when an individual performs a specific action AND when they observe someone else performing the same action. Originally discovered in the 1990s”'},
    {title: 'Toxic Compassion', date: '7/6/2024', body: '“The prioritization of short term emotional comfort over long-term outcomes - disregarding truth.”'}, 
    {title: '3 Forms of Leverage - Labor, Capital, and Product.', date: '7/6/2024', body: `"Traditionally, labor leverage comes from having people work for you. This is the oldest form of leverage and is often the first one people think of. You hire employees, build a team, and your efforts are multiplied through the collective work of others. However, labor leverage usually requires permission in the form of hiring, and it involves managing people, which can be complex and time-consuming. 
